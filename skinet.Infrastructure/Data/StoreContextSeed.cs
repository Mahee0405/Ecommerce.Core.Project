...
namespace skinet.Infrastructure.Data
{
    ...
    {
        public static async Task SeedAsync(StoreContext context, ILoggerFactory loggrfactory)
        {
            try
            {
            ...
            {
                var logger = loggrfactory.CreateLogger<StoreContextSeed>();
                logger.LogError(ex, "Error during seed data");
            }
        }
    }
}
